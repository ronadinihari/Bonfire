...
class reports extends Admin_Controller {
	...
	public function __construct() 
	{
		...
		$this->auth->restrict('Media.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Media.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_media())
			{
				...
				Template::redirect(SITE_AREA .'/reports/media');
			}
			else 
			{
	...
	*/
	...
	{
		$this->auth->restrict('Media.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/media');
		}
	...
	*/
	...
	{	
		$this->auth->restrict('Media.Reports.Delete');
