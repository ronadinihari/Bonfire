...
<div class="view split-view">
	...
	<div class="notification attention">
		<p><?php echo lang('media_no_records'); ?> <?php echo anchor(SITE_AREA .'/settings/media/create', lang('media_create_new'), array("class" => "ajaxify")) ?></p>
	</div>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
			...
			<div class="box create rounded">
				<a class="button good ajaxify" href="<?php echo site_url(SITE_AREA .'/settings/media/create')?>"><?php echo lang('media_create_new_button');?></a>
...
?>
				<td><?php echo anchor(SITE_AREA .'/settings/media/edit/'. $record['id'], lang('media_edit'), 'class="ajaxify"'); ?></td>
			</tr>
<?php endforeach; ?>
		</tbody>
	</table>
