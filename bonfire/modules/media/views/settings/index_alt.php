<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/settings/media/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			...
			<?php endforeach; ?>
				...
				<td>
					<?php echo anchor(SITE_AREA .'/settings/media/edit/'. $record[$primary_key_field], lang('media_edit'), '') ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
